...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/x64/Debug/blackjack3D
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/x86/Debug/blackjack3D
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/ARM64/Debug/blackjack3D
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/x64/Release/blackjack3D
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/x86/Release/blackjack3D
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/blackjack3D.exe
OBJDIR = obj/ARM64/Release/blackjack3D
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
GENERATED += $(OBJDIR)/blackjack_rules.o
GENERATED += $(OBJDIR)/deck_system.o
GENERATED += $(OBJDIR)/input_system.o
GENERATED += $(OBJDIR)/main.o
GENERATED += $(OBJDIR)/money_system.o
GENERATED += $(OBJDIR)/ranking_system.o
GENERATED += $(OBJDIR)/render_system.o
OBJECTS += $(OBJDIR)/blackjack_rules.o
OBJECTS += $(OBJDIR)/deck_system.o
OBJECTS += $(OBJDIR)/input_system.o
OBJECTS += $(OBJDIR)/main.o
OBJECTS += $(OBJDIR)/money_system.o
OBJECTS += $(OBJDIR)/ranking_system.o
...
$(OBJDIR)/blackjack_rules.o: src/game/blackjack_rules.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/deck_system.o: src/game/deck_system.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/money_system.o: src/game/money_system.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/ranking_system.o: src/game/ranking_system.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/input_system.o: src/input/input_system.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/main.o: src/main.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/render_system.o: src/render/render_system.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
